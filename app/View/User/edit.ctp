...
<div class="row">
	...
	<div class="col-md-10">
		...
		<div class="form-group">
			...
			<input type="email" name="data[User][EmailAddress]" placeholder="Email Address" class="form-control" required="required" value="<?php echo $user['User']['EmailAddress']; ?>">
		</div>
		<div class="form-group">
			<label for="" class="control-label">First Name</label>
			<input type="text" name="data[User][FirstName]" placeholder="First Name" class="form-control" value="<?php echo $user['User']['FirstName']; ?>">
		</div>
		<div class="form-group">
			<label for="" class="control-label">Last Name</label>
			<input type="text" name="data[User][LastName]" placeholder="Last Name" class="form-control" value="<?php echo $user['User']['LastName']; ?>">
		</div>
		<div class="form-group">
			...
			<select name="data[User][Role]" class="form-control" id="selectRole">
				...
				<option <?php echo $user['User']['Role']===$role ? 'selected="selected"' : ''; ?> value="<?php echo $role; ?>"><?php echo ucfirst($role); ?></option>
				<?php endforeach; ?>
			</select>
		</div>
		<div class="form-group" id="teamHolder">
			...
			<select name="data[User][TeamId]" class="form-control">
				...
				<option <?php echo $user['User']['TeamId']==$team['id'] ? 'selected="selected"' : ''; ?> value="<?php echo $team['id']; ?>"><?php echo $team['name']; ?></option>
				<?php endforeach; ?>
			</select>
		</div>
